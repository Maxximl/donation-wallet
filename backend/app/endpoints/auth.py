...
from app.schemas import RegistrationForm, Token
from app.schemas import User as UserSchema
from app.services.user_manager import authenticate_user, create_access_token, delete_user, get_current_user, register_user
